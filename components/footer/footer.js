        ...
        <FooterContainer>
          <FooterTopContainer>
            ...
            <FooterConnectColumn>
              ...
              <FooterSocials>
                <SocialIcon url={config.socials.github} fgColor="var(--text-color)" bgColor="var(--secondary-color)" title="GitHub" style={{ height: 25, width: 25, margin: 'var(--space-sm)' }}/>
                <SocialIcon url={config.socials.twitter} fgColor="var(--text-color)" bgColor="var(--secondary-color)" title="Twitter" style={{ height: 25, width: 25, margin: 'var(--space-sm)' }}/>
                <SocialIcon url={config.socials.linkedin} fgColor="var(--text-color)" bgColor="var(--secondary-color)" title="Linkedin" style={{ height: 25, width: 25, margin: 'var(--space-sm)' }}/>
                <SocialIcon url={config.socials.instagram} fgColor="var(--text-color)" bgColor="var(--secondary-color)" title="Instagram" style={{ height: 25, width: 25, margin: 'var(--space-sm)' }}/>
                <SocialIcon url="mailto:kontakt@gis-netzwerk.com" fgColor="var(--text-color)" bgColor="var(--secondary-color)" title="E-Mail" style={{ height: 25, width: 25, margin: 'var(--space-sm)' }}/>
              </FooterSocials>
