...
import DeckGL from '@deck.gl/react';import {WebMercatorViewport} from '@deck.gl/core';
...
export default function ActivitiesMap({
  ...
  const center = [(maxLatitude+minLatitude)/2,(maxLongitude+minLongitude)/2]
  ...
  return (
    <MapContainer>
      <DeckGL
        ...
        controller={true}
      >
        <StaticMap reuseMaps mapStyle={'https://basemaps.cartocdn.com/gl/dark-matter-gl-style/style.json'} preventStyleDiffing={true} />
