...
const config = {
  ...
  siteTitleShort: "mxd", // Short site title for homescreen (PWA). Preferably should be under 12 characters to prevent truncation.
  siteTitleAlt: "mxd", // Alternative site title for SEO.
  ...
  backgroundColor: "#0a19241c", // Used for setting manifest background color.
