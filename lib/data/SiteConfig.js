...
const config = {
  ...
  themeColor: "#071017", // Used for setting manifest and progress theme colors.
  backgroundColor: "#0a1924", // Used for setting manifest background color.
  ...
  socials: { // socials
    ...
    mail: "mailto:max.dietrich@gis-netzwerk.com",
  },
};
