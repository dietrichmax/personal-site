...
const HeroWrapper = styled.div`
  ...
  background-image: ${props => props.location ? `url("https://api.mapbox.com/styles/v1/mapbox/dark-v10/static/${props.location.lon},${props.location.lat},12/1280x700?access_token=${process.env.NEXT_PUBLIC_MAPBOX_ACCESS_TOKEN}")` : ""};
