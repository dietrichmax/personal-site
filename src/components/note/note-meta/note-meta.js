        ...
        <MetaInnerWrapper>
          ...
          <MetaItem>
            <Location
              ...
              title="View this location in OpenStreetMap"
              href={`http://www.openstreetmap.org/?mlat=${note.lat}&mlon=${note.lon}&zoom=12`}
            >
              <FaMapMarkerAlt />
            </Location>{" "}
            |{" "}
          ...
          <MetaItem>
            ...
            {note.temperature ? (
              <Temperature title={`${note.temperature.toFixed(0)}°Celsius`}>
                {" "}
                {note.temperature.toFixed(0)}°C
              </Temperature>
            ) : null}
          </MetaItem>
        </MetaInnerWrapper>
